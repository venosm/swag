...
## Based on
This project is based on [swag/swag](https://github.com/swaggo/swag) 
...
```sh
docker run --rm -v $(pwd):/code ghcr.io/swag/swag:latest
```
...
OPTIONS:
   ...
   --overridesFile value                  File to read global type overrides from. (default: ".swag")
...
- [net/http](https://github.com/venosm/http-swagger)
- [gorilla/mux](https://github.com/venosm/http-swagger)
- [go-chi/chi](https://github.com/venosm/http-swagger)
...
Find the example source code [here](https://github.com/venosm/swag/tree/master/example/celler).
...
import "github.com/venosm/swag-files" // swagger embed files
```
...
import (
    ...
    "github.com/venosm/swag/example/celler/model"
)
...
![swagger_index.html](https://raw.githubusercontent.com/swag/swag/master/assets/swagger-image.png)

## The swag formatter

The Swag Comments can be automatically formatted, just like 'go fmt'.
Find the result of formatting [here](https://github.com/venosm/swag/tree/master/example/celler).
...
**Example**
[celler/main.go](https://github.com/venosm/swag/blob/master/example/celler/main.go)
...
**Example**
[celler/controller](https://github.com/venosm/swag/tree/master/example/celler/controller)
...
[#708](https://github.com/venosm/swag/issues/708) The parser handles only struct comments starting with `@Description` attribute.
...
[#201](https://github.com/venosm/swag/issues/201#issuecomment-475479409)
...
[#379](https://github.com/venosm/swag/issues/379)
```go
...
By passing a mapping to swag with `--overridesFile` you can tell swag to use one type in place of another wherever it appears. By default, if a `.swag` file is present in the current directory it will be used.
...
```
See [this file](https://github.com/venosm/swag/blob/master/testdata/generics_nested/api/api.go) for more details
and other examples.

### Change the default Go Template action delimiters
[#980](https://github.com/venosm/swag/issues/980)
[#1177](https://github.com/venosm/swag/issues/1177)
