...
func TestGen_BuildDescriptionWithQuotes(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/venosm/swag/testdata/quotes")
...
func TestGen_BuildDocCustomDelims(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/venosm/swag/testdata/delims")
