...
func TestNew(t *testing.T) {
	t.Run(
		"SetMarkdownFileDirectory", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"SetCodeExamplesDirectory", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"SetFieldParserFactory", func(t *testing.T) {
			t.Parallel()
...
func TestOverrides_getTypeSchema(t *testing.T) {
	...
	t.Run(
		"Override sql.NullString by string", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"Missing Override for sql.NullInt64", func(t *testing.T) {
			t.Parallel()
...
func TestParser_ParseGeneralApiInfoExtensions(t *testing.T) {
	...
	t.Run(
		"Test invalid extension value", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"Test missing extension value", func(t *testing.T) {
			t.Parallel()
...
func TestParser_ParseGeneralAPISecurity(t *testing.T) {
	...
	t.Run(
		"OAuth2Application", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"OAuth2Implicit", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"OAuth2Password", func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"OAuth2AccessCode", func(t *testing.T) {
			t.Parallel()
...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(
		SetOverrides(
			map[string]string{
				"github.com/venosm/swag/testdata/global_override/types.Application":  "string",
				"github.com/venosm/swag/testdata/global_override/types.Application2": "github.com/venosm/swag/testdata/global_override/othertypes.Application",
				"github.com/venosm/swag/testdata/global_override/types.ShouldSkip":   "",
			},
		),
	)
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
...
func TestParser_parseExtension(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(
			tt.name, func(t *testing.T) {
				err = tt.parser.ParseRouterAPIInfo(
					&AstFileInfo{
						FileSet:     fileSet,
						File:        f,
						Path:        filePath,
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/venosm/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/venosm/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/venosm/swag/gen"))

	parser = New(SetPackagePrefix("github.com/venosm/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/venosm/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/venosm/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/venosm/swag/gen"))

	parser = New(SetPackagePrefix("github.com/venosm/swag/cmd,github.com/venosm/swag/gen"))
